...
const CargoDetailed = () => {
  const getRoute = () => {
    axios.get(`https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/directions/json?origin=place_id:${postInfo.details.from}&destination=place_id:${postInfo.details.to}&key=${process.env.GOOGLE_MAP_API_KEY}`, {withCredentials: true})
      .then(res => {
